...
env = Env()
Env.read_env()  # Permet de lire un fichier .env caché pour la sécurité
...
SECRET_KEY = env('SECRET_KEY', default='une-cle-de-secours-temporaire')
DEBUG = env.bool('DEBUG', default=False) # En production, DEBUG doit être False
